...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/16 17:48:54 by akhellad          #+#    #+#             */
/*   Updated: 2023/02/17 17:02:32 by akhellad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_b_pile(size_t *minimal_mvt, size_t *m, t_pile *b_pile)
{
	if (*minimal_mvt > b_pile->tab_size / 2)
		*minimal_mvt = b_pile->tab_size - *minimal_mvt;
	*m = *minimal_mvt + 1;
						...
						t_pile *a_pile, t_pile *b_pile)
{
	...
	check_b_pile(&minimal_mvt, &m, b_pile);
	i = a_pile->tab_size;
