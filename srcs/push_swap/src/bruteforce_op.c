...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/17 16:25:55 by akhellad          #+#    #+#             */
/*   Updated: 2023/02/17 16:28:57 by akhellad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/push_swap.h"

int	reverse_rotate_bruteforce_a(t_cond **new_conds, \
			t_cond *tmp, size_t pos[2], t_pile *p_pile)
{
	size_t	j;
	t_dir	*tmp_dir;
...
int	bruteforce_choice_a(t_cond **new_conds, t_cond *tmp, size_t pos[2], \
						t_pile *b_pile)
{
