...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/17 17:17:57 by akhellad          #+#    #+#             */
/*   Updated: 2023/02/17 17:25:45 by akhellad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cond		*new_empty_condition(t_pile *a_pile, t_pile *b_pile, \
								size_t maxsize);
...
int			reverse_rotate_bruteforce_a(t_cond **new_conds, t_cond *tmp, \
										size_t pos[2], t_pile *p_pile);
int			rotate_bruteforce_a(t_cond **new_conds, t_cond *tmp, \
							size_t pos[2], t_pile *b_pile);
int			bruteforce_choice_a(t_cond **new_conds, t_cond *tmp, \
							size_t pos[2], t_pile *b_pile);
int			check_bruteforce_solution(t_cond *conds, t_cond **result);
t_cond		*pick_bruteforce_solution(t_cond *conds, size_t pos[2], \
									t_pile *b_pile);
int			bruteforce_order_a(t_init *init);
void		calcul_sort_a(size_t *pos, size_t *mvt, \
						t_pile *a_pile, t_pile *b_pile);
...
t_cond		*new_condition_direction(t_cond **conds, t_cond *old_cond, \
									char *line);
